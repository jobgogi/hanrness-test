...
description: "_workspace/commit-draft.md를 읽고 Conventinal Commits 형식·범위·diff 일치를 검증한다. PASS/REDO 판정과 사유를 리포트한다."
model: sonnet
...
3. PASS / REDO 판정을 `_workspace/commit-review.md`에 기록
...
- 형식.
  - 판정. PASS / REDO
  - 사유. [구체적 이유 2~3줄]
  - 수정 지시. [REDO일 떄만 - author가 바로 적용할 수 있게]
